...
export const metadata: Metadata = {
  title: 'Terms of Service - AirlyPay | Bleon Co LTD',
  description: 'Terms of Service for AirlyPay services provided by Bleon Co Ltd. Learn about our terms and conditions.',
}

export default function AirlyPayTermsOfService() {
  return (
