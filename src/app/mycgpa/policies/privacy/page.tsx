...
export const metadata: Metadata = {
  title: 'Privacy Policy - MyCGPA | Bleon Co LTD',
  description: 'Privacy Policy for MyCGPA services provided by Bleon Co Ltd. Learn how we collect, use, and protect your information.',
}

export default function MyCGPAPrivacyPolicy() {
  return (
