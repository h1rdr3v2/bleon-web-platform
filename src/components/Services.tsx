  ...
  const services = [
    {
      ...
      title: 'VTU Services',
      description: 'Reliable airtime and data services for all networks with instant delivery and competitive rates.',
    ...
    },
    {
      ...
      description: 'Secure payment processing and financial technology solutions for businesses.',
      color: 'from-pink-500 to-pink-600'
    },
    {
      icon: <MessageCircle className="h-8 w-8" />,
      title: 'Chatbot Development',
      description: 'Intelligent chatbot solutions for customer service and business automation.',
  ...
  const projects = [
    {
      ...
      title: 'MyCGPA',
      description: 'Comprehensive GPA calculator and academic management tool for students. Track your academic progress, calculate GPAs, and manage your educational journey.',
      features: ['GPA Calculator', 'Academic Tracking', 'Course Management', 'Progress Monitoring'],
    ...
    },
    {
      ...
      title: 'AirlyPay',
      description: 'Advanced VTU service platform with innovative giveaway features. Recharge airtime, buy data, and engage your audience with exciting giveaways.',
      features: ['VTU Services', 'Giveaway Platform', 'Multi-Network Support', 'Secure Payments'],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover some of our completed projects that showcase our technical expertise and problem-solving capabilities.
            </p>
          </div>
            ...
            {projects.map((project, index) => (
              ...
              >
                <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-gray-200 transform hover:-translate-y-2">
                  <div className={`inline-flex p-4 rounded-2xl bg-gradient-to-r ${project.color} text-white mb-6 group-hover:scale-110 transition-transform duration-300`}>
                    {project.icon}
                  </div>
        ...
        >
          <p className="text-lg text-gray-600 mb-6">
            Don&apos;t see what you&apos;re looking for? We can customize solutions for your specific needs.
          </p>
